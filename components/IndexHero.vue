    ...
    <div class="relative mx-auto max-w-7xl px-6 pt-40 lg:flex lg:px-8 lg:pt-40">
      ...
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl">
        ...
        <div class="mt-10 flex items-center gap-x-6">
          <a :href="signUp"
            class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Sign-up</a>
          <a :href="slack" class="text-sm font-semibold leading-6 text-white">Join our Slack! <span
