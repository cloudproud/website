        ...
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
              ...
              <img class="h-8 w-auto" src="@/components/images/full.svg" alt="" />
            </a>
          </div>
      ...
      <div class="relative isolate pt-14">
        ...
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <p class="mt-5 text-2xl font-bold tracking-tight text-gray-900 sm:text-2xl">A single access point for all your data</p>
            <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Streamline, Unify, Revolutionize
Your Data Management</h1>
            <p class="mt-6 text-lg leading-8 text-gray-600">Eliminate data copies
Plug and Play</p>
            <div class="mt-10 flex items-center gap-x-6">
              <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Join Beta!</a>
