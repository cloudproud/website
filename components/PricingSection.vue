    ...
    <div class="isolate overflow-hidden bg-gray-900">
        <div class="mx-auto max-w-7xl px-6 pb-96 pt-24 text-center sm:pt-32 lg:px-8">
            ...
            <div class="relative mt-6">
                <p class="mx-auto max-w-2xl text-lg leading-8 text-white/60">Lorem ipsum dolor sit, amet consectetur
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
                        <div v-for="tier in tiers" :key="tier.id"
                            ...
                            <div>
                                <h3 :id="tier.id" class="text-base font-semibold leading-7 text-indigo-600">{{ tier.name }}
                                </h3>
                                <div class="mt-4 flex items-baseline gap-x-2">
                                    <span class="text-5xl font-bold tracking-tight text-gray-900">{{ tier.priceMonthly
                                    }}</span>
                        ...
                        <div
                            ...
                            <div class="lg:min-w-0 lg:flex-1">
                                ...
                                <p class="mt-1 text-base leading-7 text-gray-600">Dolor dolores repudiandae doloribus. Rerum
