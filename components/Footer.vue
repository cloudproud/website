  ...
  <footer class="bg-gray-900" aria-labelledby="footer-heading" id="footer">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8">
      <div class="pt-8 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; {{ new Date().getFullYear() }} Cloud Proud, B.V. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@CloudProudBV',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
