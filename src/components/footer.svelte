			...
			<div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
					...
					<ul role="list" class="mt-6 space-y-4">
						<li>
							<a
								...
								class="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors"
							>
								Contact
							</a>
						</li>
				...
				<div>
					...
					<ul role="list" class="mt-6 space-y-4">
						<li>
							<a
								href="https://github.com/cloudproud"
								class="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors"
							>
								GitHub
							</a>
						...
						<li>
							<a
								href="https://www.linkedin.com/company/cloudproud"
								class="text-sm/6 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors"
							>
								LinkedIn
							</a>
				...
				<div class="flex items-center gap-6">
					...
					<div class="flex gap-4">
						...
						<a
							...
							aria-label="LinkedIn"
						>
							<svg fill="currentColor" class="size-5" aria-hidden="true" viewBox="0 0 24 24">
								<path
